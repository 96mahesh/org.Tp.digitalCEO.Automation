...
public class AssertManager {
	...
	public void sAssertContains(String actual, String expected, String message, boolean screenshot, Boolean...hardAssert) {
		if (expected.equals(actual)) {
			if(screenshot) {
				LOGGER.logTestStep(extentTest, "PASS", message + " - Successful.Contains Expected match with Actual value:"+expected, true);
			}else {
				LOGGER.logTestStep(extentTest, "PASS", message + " - Successful.Contains Expected match with Actual value:"+expected, false);
			}
	...
	public void log(String msg, WebDriver driver) throws IOException {
